...
class ThemeElement:
    def __init__(self, element_type="text", **kwargs):
        ...
        # Thermal reaction
        self.thermal_enabled = kwargs.get("thermal_enabled", False)
        self.thermal_warn_value = kwargs.get("thermal_warn_value", 65)
        self.thermal_warn_color = kwargs.get("thermal_warn_color", "#ffaa00")
        self.thermal_crit_value = kwargs.get("thermal_crit_value", 80)
        self.thermal_crit_color = kwargs.get("thermal_crit_color", "#ff0000")
    ...
    def to_dict(self):
        return {
            ...
            "thermal_warn_value": self.thermal_warn_value,
            "thermal_warn_color": self.thermal_warn_color,
            "thermal_crit_value": self.thermal_crit_value,
            "thermal_crit_color": self.thermal_crit_color,
